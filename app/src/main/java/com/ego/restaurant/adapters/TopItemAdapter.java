...
public class TopItemAdapter extends BaseAdapter {
    ...
    public TopItemAdapter(Context c, List<String> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv.setText((position + 1) + ". " + items.get(position));
        tv.setTextSize(14f);
        tv.setPadding(24, 16, 24, 16);
        tv.setBackgroundColor(position == 0 ? 0xFFFFF3E0 : android.graphics.Color.WHITE);
        return convertView;
    }
}
